...
// ---------- Negocios de ejemplo (panel /admin) ----------

export function sampleAdminBusinesses(): Business[] {
  return [
    {
      id: "biz_demo1",
      ...
      telefono: "3312345678",
      is_active: true,
      trial_fin: todayISO(3),
      created_at: todayISO(-4),
    },
    {
      id: "biz_demo2",
      slug: "fonda-dona-rosa",
      nombre: "Fonda Doña Rosa",
      tipo: "fonda",
      dueno: "Rosa Martínez",
      telefono: "3323456789",
      is_active: true,
      trial_fin: todayISO(-2),
      created_at: todayISO(-9),
    },
    {
      id: "biz_demo3",
      slug: "abarrotes-lupita",
      nombre: "Abarrotes Lupita",
      tipo: "abarrotes",
      dueno: "Guadalupe Hernández",
      telefono: "3334567890",
      is_active: false,
      trial_fin: todayISO(-20),
      created_at: todayISO(-30),
    },
    {
      id: "biz_demo4",
      slug: "barberia-estilo-urbano",
      nombre: "Barbería Estilo Urbano",
      tipo: "barberia",
      dueno: "Carlos Sánchez",
      telefono: "3345678901",
      is_active: true,
      trial_fin: todayISO(6),
