...
function businessFromRow(row: Row): Business {
  return {
    ...
    estado: row.estado as Business["estado"],
    fechaInicioPrueba: row.fecha_inicio_prueba as string,
...
function businessToRow(b: Business): Row {
  return {
    ...
    plan: b.plan,
    estado: b.estado,
    fecha_inicio_prueba: b.fechaInicioPrueba,
    fecha_vencimiento: b.fechaVencimiento ?? null,
    demo: b.demo ?? false,
    app_slug: b.appSlug,
  };
}
