...
--   9. Que una cita guarde CUANDO SE COBRO, no solo a que hora estaba
--      agendada (lo que hacia aparecer ventas fantasma al cerrar turno)
--  10. Reasegurar TODAS las columnas que la app espera. Este archivo
--      arrancaba en la migracion 20260914 y daba por hecho que lo anterior
--      ya estaba corrido — y no siempre lo estaba. Por ahi se perdia el
--      costo de las ventas de producto en barberia.
--  11. Que los GASTOS tambien arranquen en cero al abrir turno (antes solo
--      las ventas se reiniciaban; los gastos seguian contando todo el dia,
--      asi que el corte de la tarde volvia a restar los de la manana)
-- ============================================================================
...
-- ==========================================================================
-- ARCHIVO: 20260923000000_cita_guarda_cuando_se_cobro.sql
-- ==========================================================================
...
-- ==========================================================================
-- ARCHIVO: 20260924000000_asegurar_columnas.sql
-- ==========================================================================
...
-- ============================================================================
-- ARCHIVO: 20260925000000_gastos_created_at.sql
-- ============================================================================
